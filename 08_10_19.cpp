...
//Stack_Push (&stk, 10) || Assert_Ok (&stk);
//
//FILE*   f = fopen ("config.txt", "r");
//if (!f) f = fopen ("../config.txt", "r");
//if (!f) f = fopen ("/config.txt", "r");
//if (!f) f = fopen ("C:/config.txt", "r");
//if (!f) f = CreateDefaultConfig ("config.txt");
//if (!f) perror ("Cannot find/create config.txt");
